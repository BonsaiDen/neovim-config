...
syn match rustMarkdownBold   "\*\*.*\*\*\|__.*__" contained
syn match rustMarkdownItalic "\*[^\*]\+\*"    contained
syn match rustMarkdownPre    "`[^\`]*`"     contained

syn match rustShebang /\%^#![^[].*/
syn region rustCommentLine                                        start="//"                      end="$"   contains=rustTodo,@Spell
syn region rustCommentLineDoc                                     start="//\%(//\@!\|!\)"         end="$"   contains=rustTodo,@Spell,rustMarkdownBold,rustMarkdownItalic,rustMarkdownPre
...
hi def link rustString        RustString
...
hi def link rustCommentLineDoc RustDoc
...
hi def link rustLifetime      RustLifetime
hi def link rustInvalidBareKeyword Error
hi def link rustExternCrate   rustKeyword
hi def link rustObsoleteExternMod Error
hi def link rustBoxPlacementParens Delimiter

hi def link rustMarkdownBold RustMarkdownBold
hi def link rustMarkdownItalic RustMarkdownBold
hi def link rustMarkdownPre RustMarkdownPre
...
let b:current_syntax = "rust_custom"
